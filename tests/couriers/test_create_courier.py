...
class TestCreateCourier:
    ...
    @allure.title('Проверка, что невозможно создать двух одинаковым курьеров')
    ...
    @allure.title('Проверка, что невозможно создать курьера с незаполненными обязательными полями')
