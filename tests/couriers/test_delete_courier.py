...
class TestDeleteCourier:
    ...
    @allure.step('Проверка удаления курьера c возвращением успешного запроса')
    ...
    @allure.step('Проверка, что если передать несуществующий id курьера, запрос вернёт ошибку')
